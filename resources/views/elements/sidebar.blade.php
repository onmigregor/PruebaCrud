  ...
  <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
   <aside class="app-sidebar">
      <div class="app-sidebar__user">
        <div>
          <p class="app-sidebar__user-name">Ing. Ramirez Omar</p>
          <p class="app-sidebar__user-designation">Preuba Crud</p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="{{url('reportesCiudad')}}"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Reportes Ciudad</span></a></li>
